// this pipeline script is run from the build_asic Jenkins job at
// preprod01.naw03.jenkins.viasat.com/job/Mach3_Jenkins/job/Mach3_UT/job/UT_DEV/job/build_asic
...
node("vcalfutd05") {
    ...
    stage("sync perforce") {
        ...
        sh "ls -la"
        sh "ls -la /home/jenkins-ldap-svc/workspace/Mach3_Jenkins/Mach3_UT/UT_DEV/build_asic/LeapFrog/Technical/Software/code/ut/dev/core/f5/sdp/binaries/"
    }
    ...
    stage("run bash script to build blackbird platform") {
        withCredentials (
            ...
            {
                sh '''export OPENWRT_BUILD_SUBTARGET="asic"
        ...
        script {
            buildJob (
                ...
                [   string(name: 'branchName', value: "${params.git_branch}"),
                    string(name: 'SUBTARGET', value: "asic"),
